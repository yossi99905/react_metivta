...
function CategoryInfo({ name, score, onClickEditCategory, onDeleteCategory }) {
    return (
        <div className="grid grid-cols-10 text-center  h-14    px-10 bg-tailwind-green-bright *:self-center">
            ...
            <button onClick={() => onDeleteCategory(name)} className=" col-span-3 bg-red-500 hover:bg-red-600 size-9 rounded-full opacity-70 sm:col-span-1 "><FontAwesomeIcon icon={faTrashCan} /></button>
