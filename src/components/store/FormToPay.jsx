            ...
            <div className='bg-tailwind-cream flex justify-center items-center max-w-[500px] m-auto rounded-lg shadow-md'>
                <div className='flex flex-col  space-y-8 my-10 mx-4 '>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} >
                        <input {...register("email", { required: true, minLength: 2 })} type="text" placeholder="הזן איימל" className='rounded-2xl p-2 text-right w-full' />
                        {
                            <ul>
                                <li>email</li>
                            </ul>
                        }
                        <input {...register("secretCode", { required: true, minLength: 4, maxLength: 4 })} type="text" placeholder="הזן קוד" className='rounded-2xl p-2 text-right w-full' />
