...
function UserInformation({ name, secretCode, active, classRoom, left, right }) {
  ...
  return (
    <div className={`${!active && 'hidden '}e rounded-lg h-96 w-80 border border-spacing-2 absolute left-${left} right-${right} top-18 *:text-whit text-center bg-white`}>
      <div className='bg-tailwind-green-bright h-20'></div>
